...
static void from_json(const json& j, Trails& t)
{
    ...
    read<value_t::object>(j, "Local Player Extra", t.localPlayerextra);
...
static void from_json(const json& j, Config::Aimbot& a)
{
    ...
    read<value_t::boolean>(j, "Multidistance", a.multidistance);
    read_number(j, "Hitchance", a.hitChance);
    read_number(j, "Maxtrigger Inaac", a.maxTriggerInaccuracy);
    read<value_t::boolean>(j, "Autostop", a.autoStop);
    read<value_t::boolean>(j, "Oldstyle", a.oldstyle);
    read<value_t::boolean>(j, "baim", a.baim);
...
static void from_json(const json& j, Config::Backtrack& b)
{
    ...
    read<value_t::boolean>(j, "fakeLat", b.fakeLatency);
    read<value_t::boolean>(j, "allchams", b.backtrackAll);
    read<value_t::boolean>(j, "extended", b.extendedrecords);
    read_number(j, "crumbtime", b.breadcrumbtime);
    read_number(j, "existtime", b.breadexisttime);
...
static void from_json(const json& j, Config::Visuals& v)
{
    ...
    read<value_t::object>(j, "PCWorld", v.PrecacheWorld);
    read<value_t::object>(j, "NCWorld", v.NonCachedWorld);
    read<value_t::object>(j, "PCProps", v.PrecacheProps);
    read<value_t::object>(j, "NCProps", v.NonCached);
    read<value_t::object>(j, "Nightmode", v.NightMode);
    read<value_t::object>(j, "BulletTracers", v.bulletTracers);
...
static void to_json(json& j, const Trails& o, const Trails& dummy = {})
{
    ...
    WRITE("Local Player Extra", localPlayerextra);
    WRITE("Allies", allies);
...
static void to_json(json& j, const Config::Aimbot& o, const Config::Aimbot& dummy = {})
{
    ...
    WRITE("Maxtrigger Inaac", maxTriggerInaccuracy);
    WRITE("Autostop", autoStop);
    WRITE("Oldstyle", oldstyle);
    WRITE("baim", baim);
...
static void to_json(json& j, const Config::Backtrack& o, const Config::Backtrack& dummy = {})
{
    ...
    WRITE("fakeLat", fakeLatency);
    WRITE("allchams", backtrackAll);
    WRITE("extended", extendedrecords);
    WRITE("crumbtime", breadcrumbtime);
    WRITE("existtime", breadexisttime);
...
static void to_json(json& j, const Config::Visuals& o)
{
    ...
    WRITE("PCWorld", PrecacheWorld);
    WRITE("NCWorld", NonCachedWorld);
    WRITE("PCProps", PrecacheProps);
    WRITE("NCProps", NonCached);
    WRITE("Nightmode", NightMode);
    WRITE("BulletTracers", bulletTracers);
